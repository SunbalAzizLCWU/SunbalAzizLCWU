  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {isTerminal ? (
        ...
        <div className="flex flex-col gap-2 relative">
          <label className="font-code-display text-xs text-primary flex items-center gap-2">
            <span className="material-symbols-outlined text-[14px]">{'\ueb8e'}</span> const name =
          </label>
      ...
      {isTerminal ? (
        ...
        <div className="flex flex-col gap-2 relative">
          <label className="font-code-display text-xs text-primary flex items-center gap-2">
            <span className="material-symbols-outlined text-[14px]">{'\ueb8e'}</span> const email =
          </label>
          <div className="relative flex items-center">
            <span className="absolute left-3 text-primary font-code-display animate-pulse">&gt;</span>
      ...
      {isTerminal ? (
        ...
        <div className="flex flex-col gap-2 relative mt-2">
          <label className="font-code-display text-xs text-primary flex items-center gap-2">
            <span className="material-symbols-outlined text-[14px]">{'\ueb8e'}</span> const message =
          </label>
      ...
      {status === 'error' && (
        <div className="p-4 rounded-lg border border-error/40 bg-error/10 flex items-center gap-3">
          <span className="material-symbols-outlined text-error text-xl">{'\uf8b6'}</span>
      ...
      <div className={`pt-2 flex ${isTerminal ? 'justify-end' : 'items-center'}`}>
        ...
        >
          ...
          <span className="material-symbols-outlined text-[18px] group-hover:translate-x-1 transition-transform">{'\ue163'}</span>
        </button>
      </div>
    </div>
  )

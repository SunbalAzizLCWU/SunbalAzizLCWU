          ...
          {certs.map(({ abbr, company, title, date, tags, verifyUrl, icon }, i) => (
            ...
            >
              ...
              <div className="pt-3 border-t border-outline-variant/20">
                ...
                >
                  <span className="material-symbols-outlined text-[14px] group-hover/btn:rotate-12 transition-transform duration-300">verified</span>
                  VERIFY CREDENTIAL
                  <span className="material-symbols-outlined text-[14px] group-hover/btn:translate-x-0.5 transition-transform duration-300">open_in_new</span>
                </a>
              </div>
            </div>
          ))}
